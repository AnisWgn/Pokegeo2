                    ...
                    <tbody>
                        <?php while ($user = $result->fetch()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_user.php?id=<?php echo $user['id']; ?>" class="btn btn-action btn-edit me-2" 
                                            onclick="return confirm('Êtes-vous sûr de vouloir modifier cette user ?')">
                                            <i class="fas fa-edit"></i> Modifier
                                    </a>
                                    <a href="delete_user.php?id=<?php echo $user['id']; ?>" class="btn btn-action btn-delete" 
                                            onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette user ?')">
